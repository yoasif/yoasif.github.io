...
Clearly, if a license grant isn't present in the Terms, users aren't automatically granting *expansive* rights like letting a print shop republish dozens of copies of their work for free after making a single printout. If such a grant was automatic, vendors wouldn't need to write it into an agreement that must be clicked through. Vendors that *do* assert such rights in their Terms can expect them to be operative, as ["clickwrap" agreements have been held to be enforceable](https://www.mcglinchey.com/insights/split-supreme-judicial-court-issues-important-update-to-clickwrap-arbitration-clause-jurisprudence/).
